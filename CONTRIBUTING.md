...
- [ ] Compressing prompt: Use small model to retain what happened in the past, good memory management is key
...
- [ ] Try finetuning a smaller model on good prompts from deepseek-v2 or Claude
